...
export default function GroupSharedEntries() {
  ...
  const handleRotateCode = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to rotate join code');
    }
  };
          ...
          {entriesLoading ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">Members can share journal entries with this group</p>
              </CardContent>
            </Card>
          ) : (
          ...
          {isOwner && (
            <Card className="border-primary/20">
              <CardHeader>
                ...
                <CardDescription>Share this code with others to invite them to this group</CardDescription>
              </CardHeader>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to leave {squad.name}? You'll need a new join code to rejoin.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
